...
class PegawaiPenjualanController extends Controller
{
    /**
    ...
    public function __construct()
    {
        ...
        $this->data[ 'link' ] = '/pegawai/penjualan';
        $this->page = '/pegawai/penjualan';
    ...
    */
    ...
    public function tambah()
    {
        ...
        $this->data[ 'link' ] = '/pegawai/penjualan/save';
        $this->page = '/pegawai/penjualan';
        $this->data['page'] = $this->page;
        $this->data['kode'] = $kodeoto;
        return view('pegawai/penjualan/detail', $this->data);
    }
    ...
    public function edit($kode)
    {
        ...
        if(empty($load)) {
            ...
            return redirect()->to('/pegawai/penjualan/edit/'.$a->kode);
        }
