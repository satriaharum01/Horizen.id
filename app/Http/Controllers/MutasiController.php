...
class MutasiController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->data[ 'link' ] = '/admin/mutasi';
        $this->page = '/admin/mutasi';
    ...
    public function json($periode = 0)
    {
        ...
        if($periode == 0) {
            ...
            foreach ($data as $row) {
                ...
                $row->qty_masuk = (int)$inbarangperiode;
                $row->qty_keluar = (int)$outbarangperiode;
