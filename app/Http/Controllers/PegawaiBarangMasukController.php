...
class PegawaiBarangMasukController extends Controller
{
    /**
    ...
    public function __construct()
    {
        ...
        $this->page = '/pegawai/stok';
        $this->view = 'pegawai/stok/index';
