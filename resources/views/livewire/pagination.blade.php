@if ($paginator->hasPages())
    <nav>
        <ul class="pagination d-flex" style="list-style:none;">
            @if ($paginator->onFirstPage())
            <li class="page-item hide" aria-disabled="true" aria-label="« Previous">
                <button class="page-link" disabled="true" type="button">‹</button>
            </li>
            @else
